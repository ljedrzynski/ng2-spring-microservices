...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "testservice@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "testservice API";

        private String description = "testservice API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "testservice";
